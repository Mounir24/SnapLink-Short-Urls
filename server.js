...
// WHITELIST 
const whitelist = ['http://localhost:8080', 'https://v.fastcdn.co', 'https://res.cloudinary.com', 'https://short-url-snaplink.herokuapp.com', 'https://cdnjs.cloudflare.com', 'https://cdn.deliver.net', 'https://restcountries.eu', 'https://unpkg.com'];
// CORS Options 
const corsOptions = {
